...
def generate_test_data(lambda_client, data_generator_function_name, raw_bucket):
    ...
    # TODO: assert lambda response, look at test_lambda_raw_clean.py for reference, take into account that in this case the function should return a 202 status code
